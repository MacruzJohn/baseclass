...
public class SeliniumBaseClass {
		...
		try {
			if (browserName.equalsIgnoreCase("chrome")) {
				System.setProperty("webdriver.chrome.driver",
						System.getProperty("user.dir") + ("C:\\All Files\\Software\\chromedriver.exe"));
				driver = new ChromeDriver();

			} else if (browserName.equalsIgnoreCase("firefox")) {
				System.setProperty("webdriver.gecko.driver",
						System.getProperty("user.dir") + ("C:\\All Files\\Software\\geckodriver-v0.30.0-win64\\geckodriver.exe"));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
